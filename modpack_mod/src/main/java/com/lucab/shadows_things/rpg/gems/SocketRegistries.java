...
public class SocketRegistries {
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<SocketDataComponent>> SOCKET_COMPONENT =
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<GemData>> GEM_DATA_COMPONENT =
