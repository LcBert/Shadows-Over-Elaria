package com.lucab.shadows_over_elaria.attachments;
...
public class ExhaustionAttachments implements INBTSerializable<CompoundTag> {
    ...
    public static final Supplier<AttachmentType<ExhaustionAttachments>> EXHAUSTION = ShadowsOverElaria.ATTACHMENT_TYPES
            .register(
                    "exhaustion",
